...
class TopDeliveryMan {
  ...
  TopDeliveryMan({this.deliveryMan});

  TopDeliveryMan.fromJson(Map<String, dynamic> json) {
    // totalSize = json['total_size'];
    // limit = json['limit'];
    // offset = json['offset'];
    if (json['delivery_men'] != null) {
      deliveryMan = <DeliveryMan>[];
      json['delivery_men'].forEach((v) {
  ...
  Map<String, dynamic> toJson() {
    ...
    // data['offset'] = offset;
    if (deliveryMan != null) {
      data['delivery_men'] = deliveryMan!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class DeliveryMan {
  ...
  DeliveryMan.fromJson(Map<String, dynamic> json) {
    ...
    identityImage = json['identity_image'] == null
        ? null
        : jsonDecode(json['identity_image']);
    image = json['image'];
