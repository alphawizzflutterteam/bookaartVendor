...
class Order {
  ...
  Order({
    ...
    _deliveryManStatus = deliveryManStatus;
    _cause = cause;
    ...
    if (extraCodCharge != null) {
      _extraCodCharge = extraCodCharge;
    }
  }
  ...
  int? get deliveryManStatus => _deliveryManStatus;
  ...
  double? get extraCodCharge => _extraCodCharge;
  ...
  Order.fromJson(Map<String, dynamic> json) {
    ...
    if (json['delivery_man_status'] != null) {
      _deliveryManStatus = json['delivery_man_status'];
    }
    ...
    if (json['extra_cod_charge'] != null) {
      _extraCodCharge = json['extra_cod_charge'].toDouble();
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['extra_cod_charge'] = _extraCodCharge;
