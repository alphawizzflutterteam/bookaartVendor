...
class AppConstants {
  ...
  static const String bonustransactionsUri = '/api/v3/seller/bonustransaction';
  static const String getWalletTransaction =
      '/api/v3/seller/get_wallet_transaction';
  ...
  static const String sellerCategoryUri = '/api/v3/seller/seller_category/list';
  static const String categoryUri = '/api/v1/categories/get_categories';
  ...
  static const String getFlashDealsUri = '/api/v3/seller/deal/list';
  static const String getFlashDealUri = '/api/v3/seller/deal/detail/';
  static const String addDeliveryManNewUri =
      '/api/v3/seller/delivery-man/store-search';
  static const String deleteFlashDealProductUri =
      '/api/v3/seller/deal/delete-product/';
  ...
  static const String getDeliveryManNewUri =
      '/api/v3/seller/seller-delivery-man-new';
  static const String assignDeliveryManUri =
      '/api/v3/seller/orders/assign-delivery-man';
  static const String addFlashListProductUri =
      '/api/v3/seller/deal/add-product/';
  ...
  static const String assignDeliveryMan = '/api/v3/seller/assign-delivery-man';
  static const String getDeliveryManListApi = '/api/v3/seller/get-delivery-man';
  ...
  static const String deliveryManListNewUri =
      '/api/v3/seller/delivery-man/list-new';
  ...
  static const String updateProductStatus =
      '/api/v2/seller/products/status-update';
  ...
  static const String businessAnalytics2 =
      '/api/v3/seller/service-statistics?statistics_type=';
  ...
  static const String addMoney = "/api/v3/seller/add_money";
  static const String addFundMoney = "/api/v3/seller/request_money";
