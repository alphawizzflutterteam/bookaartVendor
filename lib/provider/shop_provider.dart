...
class SellerProvider extends ChangeNotifier {
  ...
  List<SellerCategoryModel>? _sellerCategoryList;
  List<SellerSubcategory>? _sellerSubCategoryList;
  List<SubCategory>? _subCategoryList;
  List<SubSubCategory>? _subSubCategoryList;
  int? _categorySelectedIndex;
  String? _selectedSellerSubCate;
  String? _selectedSellerCate;
  int? _selectedSellerSubCateId;
  int? _selectedSellerCateId;
  ...
  ///seller selected category and subcategory
  String? get selectedSellerSubCate => _selectedSellerSubCate;
  String? get selectedSellerCate => _selectedSellerCate;
  int? get selectedSellerSubCateId => _selectedSellerSubCateId;
  int? get selectedSellerCateId => _selectedSellerCateId;
      ...
      if (product != null &&
        ...
        if (_subSubCategoryList != null) {
          ...
          if (product.categoryIds!.length > 2) {
            print('_safsfsdf_________Asds${product.categoryIds![2].id!}');
  ...
  void pickImage(bool isLogo, bool isMeta, bool isRemove, int? index,
    ...
    if (isRemove) {
      ...
      if (isLogo) {
        ...
        _pickedMeta = await ImagePicker().pickImage(
            source: source ?? ImageSource.gallery,
            imageQuality: 80,
            maxWidth: 400,
            maxHeight: 400);
        ...
        _coveredImage = await ImagePicker().pickImage(
            source: source ?? ImageSource.gallery,
            imageQuality: 80,
            maxWidth: 400,
            maxHeight: 400);
  ...
  Future addProductImage(BuildContext context, ImageModel imageForUpload,
    ...
    if (response.response != null && response.response!.statusCode == 200) {
      ...
      print("responseresponse map $map");
      ...
      print("responseresponse productReturnImage $productReturnImage");
  ...
  Future<void> addProduct(
    ...
    _isLoading = true;
    notifyListeners();
    print("Final productReturnImage: $productImages");
    print("Final colorImageObject: $colorImageObject");
    print("Thumbnail: $thumbnail");
    print("Meta Image: $metaImage");
