...
class AuthProvider with ChangeNotifier {
  ...
  XFile? get aadharCard => _aadhar;
  XFile? get aadharBack => _aadharBack;
  XFile? get panCard => _panCard;
  ...
  TextEditingController typeController = TextEditingController(text: 'service');
  ...
  FocusNode gstNode = FocusNode();
  FocusNode adharNode = FocusNode();
  ...
  void pickImage(bool isProfile, bool shopLogo, bool isRemove, bool isAadhar,
    ...
    if (isRemove) {
      ...
      if (isProfile) {
        ...
        _aadhar = await ImagePicker().pickImage(source: ImageSource.gallery);
      } else if (isPanCard) {
