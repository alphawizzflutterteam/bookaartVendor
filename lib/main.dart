...
import 'package:sixvalley_vendor_app/view/screens/order/order_service.dart';
...
//  final int? orderId;
  ...
  late StreamSubscription<bool> _orderCheckSubscription;
  // const MyApp({Key? key, this.orderId}) : super(key: key);
  ...
  @override
  void dispose() {
    _orderCheckSubscription.cancel();
    super.dispose();
  }
      ...
      child: Sizer(
        builder: (context, orientation, deviceType) {
          return MaterialApp(
            ...
            home: SplashScreen(orderId: widget.orderId),
          );
        },
      ),
    );
