          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    borderRadius: const BorderRadius.only(
                      ...
                      bottomRight:
                          Radius.circular(Dimensions.paddingSizeVeryTiny),
                      bottomLeft:
                          Radius.circular(Dimensions.paddingSizeVeryTiny),
                    )),
                child: Row(
                        ...
                        ? Container(
                            ...
                            child: Text(
                                PriceConverter.convertPrice(
                                    context, refundModel!.product?.unitPrice),
                                style: robotoMedium.copyWith(
                                    color: Colors.white,
                                    fontSize: Dimensions.fontSizeLarge)),
                          )
              ...
              Padding(
                ...
                child: Text(
                    '${getTranslated('requested_on', context)} : ${DateConverter.localDateToIsoStringAMPM(DateTime.parse(refundModel!.createdAt!))}',
                    style: robotoRegular.copyWith(
                                ...
                                Row(
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child:
                                          Image.asset(Images.orderPendingIcon),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text(
                                          getTranslated(
                                              refundModel!.status, context)!,
                                          style: robotoRegular.copyWith(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        refundModel!.order != null
                                            ? refundModel!.order!.paymentMethod!
                                            : '',
                                        style: robotoRegular.copyWith(
                                            fontSize:
                                                Dimensions.fontSizeDefault,
                ...
                child: isDetails
                    ? Column(
                        ...
                        children: [
                          ...
                          Text(
                            refundModel?.refundReason ?? 'No reason provided',
                            overflow: TextOverflow.ellipsis,
                    ...
                    : Row(
                        ...
                        children: [
                          ...
                          refundModel != null &&
                              ...
                              : const SizedBox(), // or show fallback text
