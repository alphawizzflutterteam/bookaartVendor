...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  Widget build(BuildContext c) {
    print("heheh ${widget.orderModel?.expectedDeliveryDate}");
      ...
      body: RefreshIndicator(
        ...
        child: Consumer<OrderProvider>(builder: (context, order, child) {
          ...
          double otherCityShippingCost =
              widget.orderModel!.otherCityShippingCost ?? 0;
          double extraCodCharge = widget.orderModel!.extraCodCharge ?? 0;
              ...
              ? order.orderDetails!.isNotEmpty
                  ? ListView(
                      ...
                      children: [
                        ...
                        if (widget.orderModel?.cause != null &&
                            widget.orderModel?.cause != "resume")
                          Container(
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(
                                        "${widget.orderModel?.orderStatus == "out_for_delivery" ? "Reshedule" : "Cancel"} Reason",
                                ...
                                Text(
                                    '${widget.orderModel?.cause} - ${widget.orderModel?.orderStatus == "out_for_delivery" ? widget.orderModel?.expectedDeliveryDate : ""}',
                        ...
                        //widget.orderType == 'POS'?  Text('type${}'):
                                              ...
                                              style: titilliumRegular.copyWith(
                                                  ...
                                                  color:
                                                      ColorResources.titleColor(
                                                          context))),
                                          Text(
                                              '+ ${PriceConverter.convertPrice(context, extraCodCharge)}',
                                              style: titilliumRegular.copyWith(
                                                  fontSize:
                                                      Dimensions.fontSizeLarge,
                                                  color:
                                              ...
                                              style: titilliumRegular.copyWith(
                                                  ...
                                                  color:
                                                      ColorResources.titleColor(
                                                          context))),
                                          Text(
                                              '+ ${PriceConverter.convertPrice(context, otherCityShippingCost)}',
                                              style: titilliumRegular.copyWith(
                                                  fontSize:
                                                      Dimensions.fontSizeLarge,
                                                  color:
