...
class BankEditingScreenState extends State<BankEditingScreen> {
  ...
  _updateUserAccount() async {
    ...
    if (Provider.of<BankInfoProvider>(context, listen: false)
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(getTranslated('enter_ifsc_no', context)!),
          backgroundColor: ColorResources.red));
    } else {
      ...
      updateUserInfoModel.ifscNo = _ifscController?.text ?? '';
  ...
  void initState() {
    ...
    _ifscController!.text = widget.sellerModel!.ifscNo ?? '';
  }
          ...
          builder: (context, authProvider, child) => Form(
            ...
            child: ListView(
              ...
              children: [
                ...
                Text(getTranslated('ifsc_no', context)!,
                    style: titilliumRegular.copyWith(
                      fontSize: Dimensions.fontSizeDefault,
                      color: ColorResources.getHintColor(context),
                    )),
                ...
                CustomTextField(
                  border: true,
                  hintText: getTranslated('ifsc_no_hint', context),
