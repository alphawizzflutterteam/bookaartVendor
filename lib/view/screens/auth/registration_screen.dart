                                    ...
                                    child: CustomButton(
                                      ...
                                      onTap: !authProvider.isTermsAndCondition!
                                          ...
                                          : () {
                                              ...
                                              if (authProvider.aadharCard ==
                                                  null) {
                                                showCustomSnackBar(
                                                    "Please Add Front Aadhar card",
                                                    context);
                                              }
                                              if (authProvider.aadharBack ==
                                                  null) {
                                                showCustomSnackBar(
                                              ...
                                              // }
                                                ...
                                                RegisterModel registerModel = RegisterModel(
                                                    ...
                                                    shopAddress: authProvider
                                                        ...
                                                        .text
                                                        .trim(),
                                                    area: authProvider.areaController.text.trim(),
                                                    gstNumber: authProvider.gstController.text.trim(),
                                                    city: authProvider.cityController.text.trim(),
                                                    state: authProvider.stateController.text.trim(),
                                                    zipCode: authProvider.zipCodeController.text.trim(),
                                                    sellerCategory: Provider.of<SellerProvider>(context, listen: false).selectedSellerCateId.toString(),
                                                    sellerSubCategory: Provider.of<SellerProvider>(context, listen: false).selectedSellerSubCateId.toString(),
                                                    aadharNumber: authProvider.adharController.text.trim());
                                                authProvider
                                                    .registration(
