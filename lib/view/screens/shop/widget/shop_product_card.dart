...
class _ProductWidgetState extends State<ShopProductWidget> {
  ...
  void initState() {
    ...
    super.initState();
    widget.productModel?.status==1 ?_toggleValue=true : _toggleValue=false;
  }
...
// print('id-------${widget.productModel?.id}');
                Provider.of<ProductProvider>(context,listen: false).updateProductStatusPro( _toggleValue==true ?1 :0, widget.productModel?.id ?? 0).then((value) {
