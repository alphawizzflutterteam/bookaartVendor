  ...
  Widget build(BuildContext context) {
    return Consumer<SellerProvider>(
      builder: (context, resProvider, child) {
        print("resProvider.categoryIndex ${resProvider.categoryIndex}");
          ...
          children: [
            ...
            Container(
              ...
              child: DropdownButton<int>(
                value: resProvider.categoryIndex != -1
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        // ),
                        child: DropdownButton<int>(
                          value: resProvider.subSubCategoryIndex! >= 0 &&
                                  resProvider.subSubCategoryIndex! <
                                      resProvider.subSubCategoryIds.length
                              ? resProvider.subSubCategoryIndex
                              : null,
                          items: [
                            ...
                            for (int i = 0;
                              ...
                              DropdownMenuItem<int>(
                                value: i + 1,
                                child: Text(
                                    resProvider.subSubCategoryList![i].name!),
                              ),
                          ],
                          onChanged: (int? value) {
                            resProvider.setSubSubCategoryIndex(value, true);
