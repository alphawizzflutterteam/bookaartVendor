...
class AddProductSeoScreenState extends State<AddProductSeoScreen> {
  ...
  Future<void> _uploadImagesAndSubmit() async {
    final resProvider = Provider.of<SellerProvider>(context, listen: false);
    ...
    for (int i = 0; i < resProvider.withColor.length; i++) {
      await resProvider.addProductImage(
                                          ...
                                          child: ClipRRect(
                                              ...
                                              child: FadeInImage.assetNetwork(
                                                placeholder:
                                                    Images.placeholderImage,
                                                image:
                                                    '${Provider.of<SplashProvider>(context).configModel!.baseUrls!.productImageUrl}/${_product!.images![index] ?? ''}',
                                ...
                                return index == resProvider.withoutColor.length
                                    ? GestureDetector(
                                        onTap: () => _showSelectionDialog(
                                            ...
                                            false,
                                            false,
                                            null) /*resProvider.pickImage(false, false, false, null)*/,
                                        child: Stack(
                                          children: [
                                            DottedBorder(
                                              dashPattern: const [4, 5],
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child:
                                                  ...
                                                  placeholder:
                                                      Images.placeholderImage,
                                                  image:
                                                      '${Provider.of<SplashProvider>(context).configModel!.baseUrls!.productThumbnailUrl}/${_product!.images![index] ?? ''}',
                                                  height: MediaQuery.of(context)
                                                          .size
                                                          .width /
                                                      2.3,
              ...
              ? CustomButton(
                  ...
                  onTap: () async {
                    ...
                    if (!_update && resProvider.pickedLogo == null) {
                      ...
                      print(
                          "running editt color ${resProvider.withColor.length}");
                      ...
                      print(
                          "running editt withoutcolor ${resProvider.withoutColor.length}");
                      for (int i = 0;
                          i < resProvider.withoutColor.length;
                          i++) {
                        resProvider.addProductImage(
  ...
  Future<void> _showSelectionDialog(
    ...
    if (source != null)
      provider.pickImage(isLogo, isMeta, isRemove, index, source: source);
  }
}
