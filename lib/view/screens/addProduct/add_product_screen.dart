    ...
    return Scaffold(
      ...
      body: Consumer<SellerProvider>(
        builder: (context, resProvider, child) {
          print("helloofjoejf ${resProvider.titleControllerList.first.text}");
          if (widget.product == null &&
              resProvider.titleControllerList.first.text.isEmpty) {
      ...
      bottomNavigationBar: Container(
        ...
        child: Consumer<SellerProvider>(builder: (context, resProvider, _) {
          print('PrintData:_____${resProvider.subSubCategoryIndex}______');
              ...
              ? SizedBox(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      print(
                          "ofjoejf .productCode.text ${widget.product?.code}");
                      ...
                      if (haveBlankTitle) {
                        ...
                        widget.product?.code = resProvider.productCode.text;

                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => AddProductNextScreen(
                              categoryId: resProvider.categoryIndex != null &&
                                      resProvider.categoryIndex! > 0 &&
                                      resProvider.categoryList!.length >=
                                  ...
                                  : "-1",
                              subCategoryId:
                                  resProvider.subCategoryIndex != null &&
                                          resProvider.subCategoryIndex! > 0 &&
                                          resProvider.subCategoryList!.length >=
                                              resProvider.subCategoryIndex!
                                      ? resProvider
                                          .subCategoryList![
                                          ...
                                          .toString()
                                      : "-1",
                              subSubCategoryId: resProvider
                                              .subSubCategoryIndex !=
                                          null &&
                                      resProvider.subSubCategoryIndex! > 0 &&
                                      resProvider.subSubCategoryList!.length >=
                                          resProvider.subSubCategoryIndex!
                                  ? resProvider
                                      .subSubCategoryList![
                                      ...
                                      .toString()
                                  : "-1",
                              brandId: resProvider.brandIndex != null &&
                                      brandIds.length > resProvider.brandIndex!
                                  ? brandIds[resProvider.brandIndex!].toString()
                                  : "-1",
                              unit: unitValue,
                              product: widget.product,
                              addProduct: widget.addProduct,
